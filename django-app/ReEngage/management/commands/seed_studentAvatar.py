...
from ReEngage.models import Avatar, Student, StudentAvatar


def seedStudentAvatar() -> None:
    ...
    for student in students:
        if not StudentAvatar.objects.filter(student_id=student).exists():
            ...
            StudentAvatar.objects.create(student_id=student, avatar_id=equipped_avatar, is_equipped=True)
